...
class FastRCNNLossComputation(object):
    ...
    def subsample(self, proposals, targets):
        ...
        for labels_per_image, regression_targets_per_image, proposals_per_image, matched_idxs_per_image in zip(
    ...
    def __call__(self, class_logits, box_regression, closeup_logits, closeup_labels):
        """
        Computes the loss for Faster R-CNN.
