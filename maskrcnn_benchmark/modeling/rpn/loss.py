...
class RPNLossComputation(object):
    ...
    def __call__(self, anchors, objectness, box_regression, targets, closeup_objectness):
        """
        Arguments:
        ...
        labels, regression_targets, matched_idxs = self.prepare_targets(anchors, targets)
