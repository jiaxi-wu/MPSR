...
checkpoint = torch.load('model_baseline_voc_split%d_base.pth'%split, map_location=torch.device("cpu"))
...
torch.save(checkpoint, 'voc0712_baseline_split%dbase_pretrained.pth'%split)
